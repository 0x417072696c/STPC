"""
tp53_screening.py – полный скрининг TP53 (P04637) с визуализацией.
Безопасно для демонстрации инвесторам.
"""
import allymind_core, cascade, pdb_parser
import numpy as np, matplotlib.pyplot as plt, csv, time

UNIPROT = "P04637"
PDB_ID = "3D09"  # классическая структура ДНК-связывающего домена p53
OUTPUT_CSV = "tp53_profile.csv"
OUTPUT_PNG = "tp53_vulnerability_profile.png"
